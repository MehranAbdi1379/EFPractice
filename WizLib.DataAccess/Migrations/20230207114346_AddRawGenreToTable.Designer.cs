...
namespace WizLib.DataAccess.Migrations
{
    ...
    [Migration("20230207114346_AddRawGenreToTable")]
    partial class AddRawGenreToTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WizLib.Models.Models.BookDetail", b =>
                {
                    b.Property<int>("BookDetail_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AuthorBook", b =>
                {
                    b.HasOne("WizLib.Models.Models.Author", null)
                        .WithMany()
                        .HasForeignKey("AuthorsAuthor_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WizLib.Models.Models.Book", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WizLib.Models.Models.Book", b =>
                {
                    b.HasOne("WizLib.Models.Models.BookDetail", "BookDetail")
                        .WithOne("Book")
                        .HasForeignKey("WizLib.Models.Models.Book", "BookDetail_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WizLib.Models.Models.Publisher", "Publisher")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("WizLib.Models.Models.Fluent_Book", b =>
                {
                    b.HasOne("WizLib.Models.Models.Fluent_BookDetail", "BookDetail")
                        .WithOne("Book")
                        .HasForeignKey("WizLib.Models.Models.Fluent_Book", "BookDetail_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WizLib.Models.Models.Fluent_Publisher", "Publisher")
                        .WithMany("Books")
                        .HasForeignKey("Publisher_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
